...
> mocha lib/test
  ...
  api
    validateFile
      ✓ should validate a file (81ms)
      ✓ should pass properties (80ms)
      ✓ should pass pseudo-parameters (46ms)
      ✓ should reset validator state (53ms)
    validateJsonObject
      ✓ should validate an object (45ms)
  ...
  index
    CLI - functional tests
      ✓ no parameters (129ms)
      ✓ missing file parameter (136ms)
      ✓ validate simple yaml (301ms)
      ✓ validate parameter flag (308ms)
      ✓ validate importValue flag (296ms)
      ✓ validate numeric importValue flag (293ms)
      ✓ validate pseudo flag (289ms)
      ✓ validate pseudo + parameter flag (300ms)
      ✓ invalid pseudo flag throws 2 critical error (290ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (286ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (332ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (297ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (296ms)
      ✓ handle validation exceptions - non-verbose (234ms)
      ✓ handle validation exceptions - verbose (262ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (322ms)
      ✓ parameters of the List<Number> type should accept lists as values (310ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (148ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (47ms)
  ...
  validator
    validateJsonObject
      ...
      ✓ a valid (2.json) template should return an object with validTemplate = true, no crit errors (50ms)
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (54ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (49ms)
      ✓ 2 invalid resource types should return an object with validTemplate = false, 2 crit errors (44ms)
      ...
      ✓ empty section resources should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid resource reference should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 invalid parameter reference should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 2 invalid Fn::Join's should return an object with validTemplate = false, 2 crit errors (46ms)
      ✓ 1 invalid Fn::GetAtt should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 invalid Fn::FindInMap should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 invalid Ref within Parameters should return an object with validTemplate = false, 1 crit errors (49ms)
      ✓ 1 invalid GetAZs parameter should return an object with validTemplate = false, 1 crit errors (77ms)
      ✓ 1 reference non AWS::Region GetAZs parameter should return an object with validTemplate = false, 1 warn errors (58ms)
    Fn::Join
      ✓ should error if it attempts to join anything but a list of values (42ms)
    Fn::Select JSON
      ✓ should pass validation, with flat list and intrinsic list (43ms)
      ✓ should pass validation with Parameter Collection (42ms)
      ✓ should error if index is greater than list size (45ms)
      ✓ should error if second element is not a list or a function (42ms)
      ✓ should error if first element is not a number or does not parse to a number (42ms)
      ✓ should error if first element is not defined or is null (42ms)
      ✓ should error if only one element as argument list (44ms)
      ✓ should error if second element is null or undefined (42ms)
      ✓ should error if second element does not resolve to a list (42ms)
      ✓ should error if first element does not resolve to a number (42ms)
      ✓ should error if first element attempts an invalid intrinsic function (44ms)
      ✓ should error if first element is anything other than non-array object, number or string (42ms)
      ✓ should error if second element attempts an invalid intrinsic function (42ms)
      ✓ should error if second element contains a list with null values (41ms)
    Fn::Select YAML
      ✓ should validate in yaml with literal and intrinic elements in array (44ms)
      ✓ should validate in yaml with Comma Separated List Param (42ms)
      ✓ should error if index is greater than list size (42ms)
      ✓ should error if second element is not a list or a function (42ms)
      ✓ should error if first element is not a number or does not parse to a number (42ms)
      ✓ should error if first element is not defined or is null (44ms)
      ✓ should error if only one element as argument list (43ms)
      ✓ should error if second element is null or undefined (43ms)
      ✓ should error if second element does not resolve to a list (43ms)
      ✓ should error if first element does not resolve to a number (45ms)
      ✓ should error if first element attempts an invalid intrinsic function (42ms)
      ✓ should error if first element is anything other than non-array object, number or string (42ms)
      ✓ should error if second element attempts an invalid intrinsic function (43ms)
      ✓ should error if second element contains a list with null values (46ms)
    Fn::Sub
      ✓ 3 valid Fn::Sub should return an object with validTemplate = true, 0 crit errors (42ms)
      ✓ a sub referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (42ms)
      ✓ a sub getatt an invalid resource should result in validTemplate = false, 2 crit errors, no warnings (43ms)
      ✓ a sub with nested intrinsic values should result in validTemplate = true, 0 crit errors, no warnings (45ms)
    Fn::ImportValue
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ a valid Fn::ImportValue should return an object with validTemplate = true, 0 crit errors (43ms)
      ✓ an Fn::ImportValue with a correct override should return an object with validTemplate = true, 0 crit errors (44ms)
    Fn::GetAtt
      ✓ Fn::GetAtt for an arbitrary attribute on a custom resource should return a mock result (43ms)
      ✓ should pass validation where !GetAtt returns a list (45ms)
      ✓ should not pass validation where !GetAtt returns a list (45ms)
      ✓ should not pass validation with !GetAtt where attribute does not exist (44ms)
      ✓ should pass validation where !GetAtt returns some unexpected attribute for AWS::CloudFormation::Stack (42ms)
      ✓ should not pass validation with !GetAtt where the resource does not exist (42ms)
    conditions
      ✓ 1 invalid if condition arguments should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 invalid if condition should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 invalid condition value should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid condition value type should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 valid condition value type should return an object with validTemplate = true, 0 crit errors (50ms)
    Fn::Split
...
{ info: [], warn: [], crit: [] }
    ...
    templateVersion
      ✓ 1 invalid template version should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 missing template version should return an object with validTemplate = true, 0 crit errors (69ms)
    propertyValidation
      ✓ 1 invalid arn property should return an object with validTemplate = false, 1 crit errors (59ms)
      ✓ 1 invalid property name of ResourceType should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid property name of PropertyType should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 invalid property name of Tag list should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 string property should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 missing propertyType property should return an object with validTemplate = false, 1 crit errors (53ms)
      ✓ 1 missing resourceType  property should return an object with validTemplate = false, 1 crit errors (51ms)
      ✓ 1 missing (via AWS::NoValue) property should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (46ms)
      ✓ 4 invalid nested properties should return an object with validTemplate = false, 4 crit errors (49ms)
      ✓ a valid template with a Map property should return an object with validTemplate = true, no crit errors (45ms)
      ✓ an invalid template with a Map property should return an object with validTemplate = false, 1 crit error (45ms)
      ✓ a valid (valid_timestamp.yaml) template with a Timestamp should return an objcet with validTemplate = true (51ms)
      ✓ a (invalid_timestamp.yaml) template with an invalid Timestamp should return an objcet with validTemplate = false, 2 crit errors (54ms)
      ✓ a valid template with APIG string results in validTemplate = true, 0 crit error (46ms)
    validateYamlFile
      ✓ a valid (1.yaml) template should return an object with validTemplate = true, no crit errors (50ms)
      ✓ a valid (2.yaml) template should return an object with validTemplate = true, no crit errors (55ms)
      ✓ a valid (valid_minus_one_as_string.yaml) template should return an object with validTemplate = true, no crit errors (42ms)
    issues
      ✓ a valid ASG template with Tags property should return an object with validTemplate = true, no crit errors (46ms)
      ✓ both methods of defining a custom resource should result in validTemplate = true, no crit errors (43ms)
      ✓ numeric properties should result in validTemplate = true, no crit errors, no warn errors (43ms)
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors (41ms)
      ✓ Reference to RDS attribute validTemplate=true, no crit errors, no warn errors (42ms)
      ✓ if condition not working as expected, no crit errors, no warn errors (46ms)
      ✓ if condition not working as expected, 2 crit errors, no warn errors (42ms)
      ✓ a list of an extended parameter type should be properly mocked without causing an exception (47ms)
      ✓ a null property value should not cause an exception (42ms)
      ✓ Fn::Split should support function "Fn::ImportValue" (63ms)
      ✓ a template with properties containing nested aggregate types should be validated successfully (169ms)
      ✓ Issue #214 - SQS Queues now accept Tags (44ms)
      ✓ Issue #221 - Allow sub with split (42ms)
      ✓ Issue #212 - Ref does not account for resources that return ARNS (47ms)
    parameters-validation
      ✓ an unallowed parameter value provided at runtime gets rejected (42ms)
      ✓ an allowed parameter value provided at runtime gets allowed (43ms)
      ...
      ✓ parameters in guessParameters should be permitted to be guessed (42ms)
      ✓ List<AWS::EC2::AvailabilityZone::Name> should return a list (43ms)
      ✓ List<AWS::EC2::Image::Id> should return a list (41ms)
      ✓ List<AWS::EC2::Instance::Id> should return a list (42ms)
      ✓ List<AWS::EC2::SecurityGroup::GroupName> should return a list (42ms)
      ✓ List<AWS::EC2::SecurityGroup::Id> should return a list (45ms)
      ✓ List<AWS::EC2::Subnet::Id> should return a list (42ms)
      ✓ List<AWS::EC2::Volume::Id> should return a list (42ms)
      ✓ List<AWS::EC2::VPC::Id> should return a list (60ms)
      ✓ List<AWS::Route53::HostedZone::Id> should return a list (66ms)
    pseudo-parmeters
      ✓ defining an override for accountId should result in validTemplate = true, no crit errors, no warnings (49ms)
      ✓ using the pseudo parameter AWS::URLSuffix should result in validTemplate = true, no crit errors, no warnings (43ms)
      ✓ using the pseudo parameter AWS::Partition should result in validTemplate = true, no crit errors, no warnings (45ms)
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (126ms)
      ✓ should validate using custom resource attribute values for logical-names (116ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (114ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (117ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (154ms)
    output-references
      ✓ an output referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (42ms)
      ✓ an output referencing an valid resource should result in validTemplate = true, 0 crit errors, no warnings (44ms)
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (95ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (279ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (178ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (942ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (474ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (282ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (603ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (167ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (486ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (372ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (451ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (182ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (313ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (297ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (337ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (337ms)
      ✓ a template missing a required property should fail validation (171ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (502ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (500ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (89ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (90ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (548ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (513ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (465ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (89ms)
