...
> mocha lib/test
  ...
  index
    CLI - functional tests
      ✓ no parameters (110ms)
      ✓ missing file parameter (109ms)
      ✓ validate simple yaml (222ms)
      ✓ validate parameter flag (215ms)
      ✓ validate importValue flag (214ms)
      ✓ validate numeric importValue flag (210ms)
      ✓ validate pseudo flag (210ms)
      ✓ validate pseudo + parameter flag (218ms)
      ✓ invalid pseudo flag throws 2 critical error (209ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (244ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (211ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (225ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (217ms)
      ✓ handle validation exceptions - non-verbose (187ms)
      ✓ handle validation exceptions - verbose (232ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (211ms)
      ✓ parameters of the List<Number> type should accept lists as values (211ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (51ms)
...
{ info: [], warn: [], crit: [] }
    ...
    issues
      ...
      ✓ a template with properties containing nested aggregate types should be validated successfully (89ms)
    ...
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (63ms)
      ✓ should validate using custom resource attribute values for logical-names (65ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (67ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (68ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (82ms)
    output-references
    ...
    type checking coverage
      ...
      ✓ should be able to determine the type of every property of every propertytype (169ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (134ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (123ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (525ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (261ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (153ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (340ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (91ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (266ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (200ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (250ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (104ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (171ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (165ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (183ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (168ms)
      ✓ a template missing a required property should fail validation (93ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (293ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (315ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (49ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (58ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (315ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (260ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (260ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (49ms)
