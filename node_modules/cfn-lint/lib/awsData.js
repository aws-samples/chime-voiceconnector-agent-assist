...
exports.awsPrimitiveTypes = ['String', 'Integer', 'Boolean', 'Json', 'Double', 'Long', 'Timestamp'];
exports.awsAggregateTypes = ['Map', 'List'];
exports.awsPropertyTemplate = {
    Documentation: '',
    Required: false,
    UpdateType: 'Mutable'
};
exports.awsResourceTypeTemplate = {
    Documentation: '',
    AdditionalProperties: false,
    Properties: {}
};
exports.awsResourcePropertyTypeTemplate = {
    Documentation: '',
    Properties: {}
};
