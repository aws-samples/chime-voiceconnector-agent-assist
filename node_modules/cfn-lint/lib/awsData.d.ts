...
export declare const awsPrimitiveTypes: string[];
export declare const awsAggregateTypes: string[];
...
export declare const awsPropertyTemplate: PropertyBase;
...
export declare type Type = ResourceType | ResourcePropertyType;
export declare const awsResourceTypeTemplate: ResourceType;
export declare const awsResourcePropertyTypeTemplate: ResourcePropertyType;
...
export declare type AWSResourcesSpecification = {
    PropertyTypes: {
...
export declare const awsResources: AWSResourcesSpecification;
