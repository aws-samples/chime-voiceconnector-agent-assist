...
program
    ...
    if (cmd.importValues) {
        try {
            for (var _d = __values(cmd.importValues), _e = _d.next(); !_e.done; _e = _d.next()) {
                var imp = _e.value;
                var kv = imp.split('=');
    ...
    if (cmd.pseudo) {
        try {
            for (var _g = __values(cmd.pseudo), _h = _g.next(); !_h.done; _h = _g.next()) {
                var pseudo = _h.value;
                // Set the parameter
                var kv = pseudo.split('=');
    ...
    if (cmd.customResourceAttributes) {
        try {
            for (var _k = __values(cmd.customResourceAttributes), _l = _k.next(); !_l.done; _l = _k.next()) {
                var customResourceAttribute = _l.value;
                // Set the parameter
    ...
    try {
        for (var _o = __values(result['errors']['info']), _p = _o.next(); !_p.done; _p = _o.next()) {
            var info = _p.value;
    ...
    try {
        for (var _r = __values(result['errors']['warn']), _s = _r.next(); !_s.done; _s = _r.next()) {
            var warn = _s.value;
    ...
    try {
        for (var _u = __values(result['errors']['crit']), _v = _u.next(); !_v.done; _v = _u.next()) {
            var crit = _v.value;
    ...
    var e_1, _c, e_2, _f, e_3, _j, e_4, _m, e_6, _q, e_7, _t, e_8, _w;
})
    .on('--help', function () {
    doNoArgument();
});
