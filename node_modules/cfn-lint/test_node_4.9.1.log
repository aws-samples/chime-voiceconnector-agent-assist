...
> mocha lib/test
  ...
  api
    validateFile
      ✓ should validate a file (102ms)
      ✓ should pass properties (89ms)
      ✓ should pass pseudo-parameters (76ms)
      ✓ should reset validator state (81ms)
    validateJsonObject
      ✓ should validate an object (82ms)
  ...
  index
    CLI - functional tests
      ...
      ✓ validate simple yaml (326ms)
      ✓ validate parameter flag (332ms)
      ✓ validate importValue flag (372ms)
      ✓ validate numeric importValue flag (341ms)
      ✓ validate pseudo flag (334ms)
      ✓ validate pseudo + parameter flag (362ms)
      ✓ invalid pseudo flag throws 2 critical error (329ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (329ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (326ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (327ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (318ms)
      ✓ handle validation exceptions - non-verbose (232ms)
      ✓ handle validation exceptions - verbose (241ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (369ms)
      ✓ parameters of the List<Number> type should accept lists as values (389ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (120ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (63ms)
  ...
  validator
    validateJsonObject
      ✓ a valid (1.json) template should return an object with validTemplate = true, no crit errors (81ms)
      ✓ a valid (2.json) template should return an object with validTemplate = true, no crit errors (79ms)
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (88ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (81ms)
      ✓ 2 invalid resource types should return an object with validTemplate = false, 2 crit errors (77ms)
      ✓ 1 missing parameter type should return an object with validTemplate = false, 1 crit errors (77ms)
      ✓ 1 invalid parameter type should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ missing section resources should return an object with validTemplate = false, 1 crit errors (80ms)
      ✓ empty section resources should return an object with validTemplate = false, 1 crit errors (75ms)
      ✓ 1 invalid resource reference should return an object with validTemplate = false, 1 crit errors (78ms)
      ✓ 1 invalid parameter reference should return an object with validTemplate = false, 1 crit errors (82ms)
      ✓ 2 invalid Fn::Join's should return an object with validTemplate = false, 2 crit errors (77ms)
      ✓ 1 invalid Fn::GetAtt should return an object with validTemplate = false, 1 crit errors (82ms)
      ✓ 1 invalid Fn::FindInMap should return an object with validTemplate = false, 1 crit errors (79ms)
      ✓ 1 invalid Ref within Parameters should return an object with validTemplate = false, 1 crit errors (78ms)
      ✓ 1 invalid GetAZs parameter should return an object with validTemplate = false, 1 crit errors (105ms)
      ✓ 1 reference non AWS::Region GetAZs parameter should return an object with validTemplate = false, 1 warn errors (101ms)
    Fn::Join
      ✓ should error if it attempts to join anything but a list of values (76ms)
    Fn::Select JSON
      ✓ should pass validation, with flat list and intrinsic list (73ms)
      ✓ should pass validation with Parameter Collection (80ms)
      ✓ should error if index is greater than list size (72ms)
      ✓ should error if second element is not a list or a function (74ms)
      ✓ should error if first element is not a number or does not parse to a number (72ms)
      ✓ should error if first element is not defined or is null (74ms)
      ✓ should error if only one element as argument list (73ms)
      ✓ should error if second element is null or undefined (75ms)
      ✓ should error if second element does not resolve to a list (73ms)
      ✓ should error if first element does not resolve to a number (72ms)
      ✓ should error if first element attempts an invalid intrinsic function (75ms)
      ✓ should error if first element is anything other than non-array object, number or string (72ms)
      ✓ should error if second element attempts an invalid intrinsic function (75ms)
      ✓ should error if second element contains a list with null values (72ms)
    Fn::Select YAML
      ✓ should validate in yaml with literal and intrinic elements in array (75ms)
      ✓ should validate in yaml with Comma Separated List Param (72ms)
      ✓ should error if index is greater than list size (74ms)
      ✓ should error if second element is not a list or a function (82ms)
      ✓ should error if first element is not a number or does not parse to a number (75ms)
      ✓ should error if first element is not defined or is null (76ms)
      ✓ should error if only one element as argument list (73ms)
      ✓ should error if second element is null or undefined (84ms)
      ✓ should error if second element does not resolve to a list (101ms)
      ✓ should error if first element does not resolve to a number (85ms)
      ✓ should error if first element attempts an invalid intrinsic function (74ms)
      ✓ should error if first element is anything other than non-array object, number or string (77ms)
      ✓ should error if second element attempts an invalid intrinsic function (74ms)
      ✓ should error if second element contains a list with null values (76ms)
    Fn::Sub
      ✓ 3 valid Fn::Sub should return an object with validTemplate = true, 0 crit errors (76ms)
      ✓ a sub referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (76ms)
      ✓ a sub getatt an invalid resource should result in validTemplate = false, 2 crit errors, no warnings (72ms)
      ✓ a sub with nested intrinsic values should result in validTemplate = true, 0 crit errors, no warnings (75ms)
    Fn::ImportValue
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (73ms)
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ a valid Fn::ImportValue should return an object with validTemplate = true, 0 crit errors (72ms)
      ✓ an Fn::ImportValue with a correct override should return an object with validTemplate = true, 0 crit errors (75ms)
    Fn::GetAtt
      ✓ Fn::GetAtt for an arbitrary attribute on a custom resource should return a mock result (74ms)
      ✓ should pass validation where !GetAtt returns a list (74ms)
      ✓ should not pass validation where !GetAtt returns a list (77ms)
      ✓ should not pass validation with !GetAtt where attribute does not exist (73ms)
      ✓ should pass validation where !GetAtt returns some unexpected attribute for AWS::CloudFormation::Stack (75ms)
      ✓ should not pass validation with !GetAtt where the resource does not exist (73ms)
    conditions
      ✓ 1 invalid if condition arguments should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ 1 invalid if condition should return an object with validTemplate = false, 1 crit errors (74ms)
      ✓ 1 invalid condition value should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ 1 invalid condition value type should return an object with validTemplate = false, 1 crit errors (74ms)
      ✓ 1 valid condition value type should return an object with validTemplate = true, 0 crit errors (80ms)
    Fn::Split
...
{ info: [], warn: [], crit: [] }
    ...
    templateVersion
      ✓ 1 invalid template version should return an object with validTemplate = false, 1 crit errors (75ms)
      ✓ 1 missing template version should return an object with validTemplate = true, 0 crit errors (72ms)
    propertyValidation
      ✓ 1 invalid arn property should return an object with validTemplate = false, 1 crit errors (74ms)
      ✓ 1 invalid property name of ResourceType should return an object with validTemplate = false, 1 crit errors (72ms)
      ✓ 1 invalid property name of PropertyType should return an object with validTemplate = false, 1 crit errors (96ms)
      ✓ 1 invalid property name of Tag list should return an object with validTemplate = false, 1 crit errors (97ms)
      ✓ 1 string property should return an object with validTemplate = false, 1 crit errors (77ms)
      ✓ 1 missing propertyType property should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ 1 missing resourceType  property should return an object with validTemplate = false, 1 crit errors (76ms)
      ✓ 1 missing (via AWS::NoValue) property should return an object with validTemplate = false, 1 crit errors (73ms)
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (79ms)
      ✓ 4 invalid nested properties should return an object with validTemplate = false, 4 crit errors (75ms)
      ✓ a valid template with a Map property should return an object with validTemplate = true, no crit errors (75ms)
      ✓ an invalid template with a Map property should return an object with validTemplate = false, 1 crit error (73ms)
      ✓ a valid (valid_timestamp.yaml) template with a Timestamp should return an objcet with validTemplate = true (77ms)
      ✓ a (invalid_timestamp.yaml) template with an invalid Timestamp should return an objcet with validTemplate = false, 2 crit errors (73ms)
      ✓ a valid template with APIG string results in validTemplate = true, 0 crit error (78ms)
    validateYamlFile
      ✓ a valid (1.yaml) template should return an object with validTemplate = true, no crit errors (78ms)
      ✓ a valid (2.yaml) template should return an object with validTemplate = true, no crit errors (79ms)
      ✓ a valid (valid_minus_one_as_string.yaml) template should return an object with validTemplate = true, no crit errors (72ms)
    issues
      ✓ a valid ASG template with Tags property should return an object with validTemplate = true, no crit errors (76ms)
      ✓ both methods of defining a custom resource should result in validTemplate = true, no crit errors (71ms)
      ✓ numeric properties should result in validTemplate = true, no crit errors, no warn errors (80ms)
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors (72ms)
      ✓ Reference to RDS attribute validTemplate=true, no crit errors, no warn errors (76ms)
      ✓ if condition not working as expected, no crit errors, no warn errors (74ms)
      ✓ if condition not working as expected, 2 crit errors, no warn errors (79ms)
      ✓ a list of an extended parameter type should be properly mocked without causing an exception (72ms)
      ✓ a null property value should not cause an exception (72ms)
      ✓ Fn::Split should support function "Fn::ImportValue" (76ms)
      ✓ a template with properties containing nested aggregate types should be validated successfully (289ms)
      ✓ Issue #214 - SQS Queues now accept Tags (102ms)
      ✓ Issue #221 - Allow sub with split (89ms)
      ✓ Issue #212 - Ref does not account for resources that return ARNS (75ms)
    parameters-validation
      ✓ an unallowed parameter value provided at runtime gets rejected (75ms)
      ✓ an allowed parameter value provided at runtime gets allowed (71ms)
      ✓ an empty parameter value provided at runtime picks up the empty default (which will throw an error) (74ms)
      ✓ missing parameters should cause an error when guessParameters is set (72ms)
      ✓ parameters in guessParameters should be permitted to be guessed (72ms)
      ✓ List<AWS::EC2::AvailabilityZone::Name> should return a list (74ms)
      ✓ List<AWS::EC2::Image::Id> should return a list (71ms)
      ✓ List<AWS::EC2::Instance::Id> should return a list (74ms)
      ✓ List<AWS::EC2::SecurityGroup::GroupName> should return a list (71ms)
      ✓ List<AWS::EC2::SecurityGroup::Id> should return a list (73ms)
      ✓ List<AWS::EC2::Subnet::Id> should return a list (71ms)
      ✓ List<AWS::EC2::Volume::Id> should return a list (74ms)
      ✓ List<AWS::EC2::VPC::Id> should return a list (72ms)
      ✓ List<AWS::Route53::HostedZone::Id> should return a list (74ms)
    pseudo-parmeters
      ✓ defining an override for accountId should result in validTemplate = true, no crit errors, no warnings (71ms)
      ✓ using the pseudo parameter AWS::URLSuffix should result in validTemplate = true, no crit errors, no warnings (76ms)
      ✓ using the pseudo parameter AWS::Partition should result in validTemplate = true, no crit errors, no warnings (72ms)
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (201ms)
      ✓ should validate using custom resource attribute values for logical-names (204ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (200ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (242ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (261ms)
    output-references
      ✓ an output referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (72ms)
      ✓ an output referencing an valid resource should result in validTemplate = true, 0 crit errors, no warnings (74ms)
      ✓ a template with an exported output missing a Name should result in validTemplate = false, 1 crit error (71ms)
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (62ms)
      ✓ should be able to determine the type of every property of every propertytype (128ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (449ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (314ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (1624ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (829ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (494ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (1045ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (304ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (855ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (646ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (780ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (306ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (601ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (649ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (639ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (541ms)
      ✓ a template missing a required property should fail validation (312ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (966ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (919ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (156ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (151ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (1010ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (803ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (802ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (152ms)
