    ...
    MutationProcessor.prototype.generateQueries = function () {
        ...
        Object.values(this.schema.namespaces).forEach(function (namespace) {
            Object.values(namespace.models)
                ...
                var createMutation = utils_1.buildGraphQLOperation(namespace, model, 'CREATE')[0];
                var updateMutation = utils_1.buildGraphQLOperation(namespace, model, 'UPDATE')[0];
                var deleteMutation = utils_1.buildGraphQLOperation(namespace, model, 'DELETE')[0];
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 7:
                                        ...
                                        _b = utils_1.buildGraphQLOperation(this.schema.namespaces[namespaceName], modelDefinition, 'GET')[0], opName_1 = _b[1], query_1 = _b[2];
