...
import { exhaustiveCheck, getIndex, isModelConstructor, traverseModel, validatePredicate, } from '../../util';
...
var AsyncStorageAdapter = /** @class */ (function () {
    ...
    AsyncStorageAdapter.prototype.query = function (modelConstructor, predicate, pagination) {
        return __awaiter(this, void 0, void 0, function () {
            var storeName, namespaceName, predicates, predicateObjs_1, type_1, idPredicate, id, record, x, all_1, filtered, all;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        storeName = this.getStorenameForModel(modelConstructor);
