...
var _require = require('../query/fetchQueryInternal'),
    getPromiseForRequestInFlight = _require.getPromiseForRequestInFlight;
...
function () {
  ...
  _proto2.resolve = function resolve() {
    if (RelayFeatureFlags.ENABLE_RELAY_CONTAINERS_SUSPENSE === true && this._isMissingData === true) {
      ...
      var promise = (_getPromiseForRequest = getPromiseForRequestInFlight(this._environment, this._selector.owner)) !== null && _getPromiseForRequest !== void 0 ? _getPromiseForRequest : this._environment.getOperationTracker().getPromiseForPendingOperationsAffectingOwner(this._selector.owner);
